...
const Projects: React.FC = () => {
  const projects = [
    ...
    {
       title: 'PET-CONNECT',
       description: 'Pet Connect is a web-based platform that connects pet owners with shelters, pet sitters, veterinarians, and pet service providers. It enables pet adoption, appointment booking, and pet care management through a unified, user-friendly interface built with React, Tailwind CSS, and Supabase.',
       image: './assets/PetConnect.png',
       technologies: ['React', 'Vite(ESM)', 'TailwindCss', 'Supabase','Node.js API', 'TypeScript','shadcn/ui'],
       githubUrl: 'https://github.com/harshp0130/Pet-Connect.git',
       liveUrl: 'https://pet-connect.me/',
